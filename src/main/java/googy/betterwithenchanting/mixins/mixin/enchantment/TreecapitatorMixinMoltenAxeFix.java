...
public class TreecapitatorMixinMoltenAxeFix {
	...
	private ItemStack[] modifyBlockResults(
		...
		return EnchantmentMixins.applyMoltenAndScevange(dropCause, ((TreecapitatorHelper) (Object) this).player, original.call(instance, world, dropCause, x, y, z, meta, tileEntity));
	}
}
