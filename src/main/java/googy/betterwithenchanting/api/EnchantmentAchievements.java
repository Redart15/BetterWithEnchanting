...
public class EnchantmentAchievements {
	...
	static {
		...
		ItemStack enchantedItem = new ItemStack(Items.TOOL_SWORD_DIAMOND);
		EnchantmentContainer.rawAddEnchantment(enchantedItem, Enchantments.CRIT.getDefaultStack());
		ItemStack enchantedBread = new ItemStack(Items.FOOD_BREAD);
	...
	public static void init(){
		OVERWORLD_PAGE.addAchievement(EnchantmentAchievements.CRAFT_ENCHANTER, -3, 2);
		OVERWORLD_PAGE.addAchievement(EnchantmentAchievements.ENCHANT_ITEM, -4, 0);
		OVERWORLD_PAGE.addAchievement(EnchantmentAchievements.ENCHANTED_FOOD, -5, -4);
		OVERWORLD_PAGE.addAchievement(EnchantmentAchievements.FULL_ENCHANTED, -5, -2);
